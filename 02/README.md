...
Вам нужно собрать и запустить программу из [предыдущего домашнего задания](https://github.com/ilyapatis24/Libraries/blob/main/03/README.md) с помощью CMake.
